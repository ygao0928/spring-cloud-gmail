...
import ltd.ygao.gmail.product.dao.BrandDao;
...
import ltd.ygao.gmail.product.dao.CategoryBrandRelationDao;
...
public class CategoryBrandRelationServiceImpl extends ServiceImpl<CategoryBrandRelationDao, CategoryBrandRelationEntity> implements CategoryBrandRelationService {
    ...
    public List<BrandEntity> getBrandsByCatId(Long catId) {
        ...
        List<BrandEntity> brandEntities = catelog_id.stream().map(item -> {
            BrandEntity entity = brandService.getById(item.getBrandId());
            return entity;
